...
<html <?php language_attributes(); ?>>
  ...
  <?php do_action('corporatez_before_site'); ?>
  	<?php 
	if ( function_exists( 'corporatez_contact_info' ) ) {
		corporatez_contact_info(); 
	}?>
	...
	<?php 
	if ( function_exists( 'corporatez_mobile_header' ) ) {
		//corporatez_mobile_header(); 
	}?>
		...
		<?php if( is_front_page() ) : ?>
			<?php
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					corporatez_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					corporatez_banner_slider();
				else :
					corporatez_banner_background();
				endif;
			?>
		<?php else : ?>
			<div class="other-header">
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() :corporatez_get_breadcrumb() );
						}else{
							corporatez_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
