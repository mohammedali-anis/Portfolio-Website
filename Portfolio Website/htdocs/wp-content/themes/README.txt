...
Corporatez is a beautiful business theme to get your web appearance.

== Description ==

CorporateZ-Ex is an awesome Corporate business theme for WordPress that provides more customizing options to people and freelancers to create a good website for their company. CorporateZ-Ex comes with some limited exciting features to create website compatible with all devices. It has the customizing options like blog slider, logo update, layout control, color modification, extra widgets, sticky menu and much more.
...
= 1.1.0 =
Added feature to update the theme.
...
Icons
The icon set used in Corporatez is FontAwesome.
